...
@Component({
  selector: 'app-interior-portfolio',
  templateUrl: './interior-portfolio.component.html',
  styleUrls: ['./interior-portfolio.component.css']
})
export class InteriorPortfolioComponent implements OnInit {
